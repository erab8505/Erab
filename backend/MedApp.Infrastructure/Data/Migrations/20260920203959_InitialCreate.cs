        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Specialties_Areas_AreaId",
                        column: x => x.AreaId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RequiresAnesthesia = table.Column<bool>(type: "bit", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_InterventionTypes_Companies_CompanyId",
                        column: x => x.CompanyId,
                        principalTable: "Companies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_InterventionTypes_Specialties_SpecialtyId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InterventionTypeId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MedicalRecords_Companies_CompanyId",
                        column: x => x.CompanyId,
                        principalTable: "Companies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_MedicalRecords_InterventionTypes_InterventionTypeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Schedulings_Companies_CompanyId",
                        column: x => x.CompanyId,
                        principalTable: "Companies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Schedulings_InterventionTypes_InterventionTypeId",
                        column: x => x.InterventionTypeId,
                        principalTable: "InterventionTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SpecialistId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    PrescriptionDate = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InterventionTypes_CompanyId_Code",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InterventionTypes_SpecialtyId",
                table: "InterventionTypes",
                column: "SpecialtyId");

            migrationBuilder.CreateIndex(
                name: "IX_MedicalRecords_CompanyId",
                table: "MedicalRecords",
                column: "CompanyId");

            migrationBuilder.CreateIndex(
                name: "IX_MedicalRecords_InterventionTypeId",
                table: "MedicalRecords",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Patients_CompanyId_DocumentId",
                table: "Patients",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Schedulings_CompanyId",
                table: "Schedulings",
                column: "CompanyId");

            migrationBuilder.CreateIndex(
                name: "IX_Schedulings_InterventionTypeId",
                table: "Schedulings",
                column: "InterventionTypeId");
            ...
            migrationBuilder.CreateIndex(
                ...
                table: "Schedulings",
                columns: new[] { "SpecialistId", "ScheduledAt" });
