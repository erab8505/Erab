      ...
      <div class="app-body">
        ...
        <aside class="app-sidebar" [class.mobile-open]="mobileMenuOpen()">
          <nav class="sidebar-nav">
            ...
            @if (authService.isSuperAdmin() || (authService.canAccessScheduling() && companyService.hasScheduling())) {
            ...
            @if (authService.isSuperAdmin() || ((authService.canAccessStudies() || authService.isReceptionist()) && companyService.hasLaboratory())) {
            ...
            @if (authService.isAdmin()) {
              ...
              @if (authService.isSuperAdmin() || companyService.hasLaboratory()) {
